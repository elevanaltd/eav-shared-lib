...
// Do not edit manually - regenerate with: npx supabase gen types typescript --project-id zbxvjyrbkycbfhwmmnmy
...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      script_workflow_status: 'draft' | 'in_review' | 'rework' | 'approved' | 'pend_start' | 'reuse'
    }
    CompositeTypes: {
      [_ in never]: never
    }
